        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Add Publisher</h1>
                </div>
            </div>
        </header>
                ...
                <div class="row justify-content-center">
                    ...
                    <?php if ($result): ?>
                        <div class="alert alert-<?php echo ($result['type'] == 'error') ? 'danger' : 'success'; ?> col-md-6 text-center">
                            ...
                            <div class="text-center"><a class="btn btn-outline-light mt-auto" href="/Project/view/publishers.php">Back to Publishers</a></div>
